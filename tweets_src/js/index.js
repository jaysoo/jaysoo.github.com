...
define('twitter/models/tweet',['backbone'], function(Backbone) {
    var Tweet = Backbone.Model.extend({});
    return Tweet;
});

define('twitter/collections/tweets',[
        'underscore',
        'backbone',
        '../models/tweet'
    ], 
 ...
 */
define('twitter/models/searcher',[
        'jquery',
        'underscore',
        'backbone'
    ], function($, _, Backbone) {
...
define('text!templates/tweets.html',[],function () { return '{{#each tweets}}\n  <li class="tweet row-fluid">\n  <span class="span1">\n    <img src="{{profile_image_url}}" alt="">\n  </span>\n  <span class="span11">\n    <strong>{{from_user_name}}</strong>\n    {{text}}\n    <small>{{naturalday created_at}}</small>\n  </span>\n  </li>\n{{/each}}\n\n';});
...
define('twitter/views/tweetsview',[
        'jquery', 
        'underscore', 
        'backbone',
        'handlebars',
 ...
 */
define('twitter/views/searcherview',[
        'backbone',
        'synapse',
